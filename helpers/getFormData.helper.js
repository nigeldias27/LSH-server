...
function checkInputSame(questionInput,submission){// Checkbox to be done
    ...
    for (
      ...
      for (
        ...
        if (
          ...
          if(checkInputSame(data.questions[questionsindex][innerquestionsindex].input,submission)!=null){
          data.questions[questionsindex][innerquestionsindex] = {
            ...
            subheadings:
              data.questions[questionsindex][innerquestionsindex].subheadings,
            val: checkInputSame(data.questions[questionsindex][innerquestionsindex].input,submission),
          };  
          }
          else{
          data.questions[questionsindex][innerquestionsindex] = {
      ...
      for (
        ...
        if (
          ...
          data.questions[questionsindex][innerquestionsindex] = {
            input: data.questions[questionsindex][innerquestionsindex].input,
            type: data.questions[questionsindex][innerquestionsindex].type,
            subheadings: data.questions[questionsindex][innerquestionsindex].subheadings,
            val: "",
          };
